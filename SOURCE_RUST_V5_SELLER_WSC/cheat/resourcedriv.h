...
#define mem_read(Addr, Type) maindriv::read<Type>(g_Sock, g_PID, Addr)
#define mem_write(Addr, Data, Type) maindriv::write<Type>(g_Sock, g_PID, Addr, Data)
#define mem_memcpy(Dst, Src, Size) maindriv::write_memory(g_Sock, g_PID, Dst, maindriv::read_memory(g_Sock, g_PID, Src, 0, Size), Size)
}